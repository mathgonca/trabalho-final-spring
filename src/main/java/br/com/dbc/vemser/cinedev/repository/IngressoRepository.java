...
//public class IngressoRepository extends Repositorio {
...
//        List<IngressoDTO> listarIngresso = new ArrayList<>();
//        Connection conexao = null;
//        try{
//            conexao = conexaoBancoDeDados.getConnection();
...
//    }
//
//    public List<Ingresso> listarIngressoComprado(Integer id) throws SQLException{
...
//            while(res.next()){
//                IngressoDTO ingresso = getIngressoResultSet(res);
...
//    }
//
//    public IngressoDTO getIngressoResultSet(ResultSet res) throws SQLException {
//
